...
var _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), _defineProperty = _interopDefault(require("@babel/runtime/helpers/defineProperty")), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), core = require("@emotion/core"), react = require("react"), ReactSelect = require("react-select"), ReactSelect__default = _interopDefault(ReactSelect), octiconsReact = require("@primer/octicons-react"), theme = require("@arch-ui/theme"), common = require("@arch-ui/common");
...
const CheckMark = ({isDisabled: isDisabled, isFocused: isFocused, isSelected: isSelected}) => {
...
}, OptionPrimitive = ({children: children, isDisabled: isDisabled, innerProps: innerProps, innerRef: innerRef, className: className}) => core.jsx("div", _extends({
  ref: innerRef,
  className: className,
  css: {
    alignItems: "center",
  ...
  let {displaySearch: displaySearch = !0, innerRef: innerRef, components: propComponents} = _ref2, props = _objectWithoutProperties(_ref2, [ "displaySearch", "innerRef", "components" ]);
