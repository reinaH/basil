...
var _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), _defineProperty = _interopDefault(require("@babel/runtime/helpers/defineProperty")), core = require("@emotion/core"), styled = _interopDefault(require("@emotion/styled")), react = require("react"), octiconsReact = require("@primer/octicons-react"), theme = require("@arch-ui/theme"), common = require("@arch-ui/common");
...
const boldBackgroundColor = {
  ...
  display: "inline-flex"
}), PillButton = styled.button(({appearance: appearance, variant: variant}) => _objectSpread(_objectSpread({}, common.uniformHeight), {}, {
...
})), Pill = react.forwardRef((_ref, ref) => {
  let {appearance: appearance = "default", children: children, onClick: onClick, onRemove: onRemove, variant: variant = "subtle"} = _ref, props = _objectWithoutProperties(_ref, [ "appearance", "children", "onClick", "onRemove", "variant" ]);
