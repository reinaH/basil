...
var _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), core = require("@emotion/core"), react = require("react"), octiconsReact = require("@primer/octicons-react"), layout = require("@arch-ui/layout"), loading = require("@arch-ui/loading"), button = require("@arch-ui/button"), theme = require("@arch-ui/theme");
...
const PageChildren = ({page: page, isLoading: isLoading, isSelected: isSelected}) => {
  ...
  return maxPage < totalPages && pages.push(core.jsx(Page, {
    ...
    onClick: handleChange,
    value: totalPages
  }, core.jsx(octiconsReact.KebabHorizontalIcon, null))), core.jsx(layout.FlexGroup, _extends({
    as: "nav",
    align: "center",
