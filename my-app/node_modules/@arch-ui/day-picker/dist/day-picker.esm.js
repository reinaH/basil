...
import React__default, { useRef, useEffect, memo, useState, useCallback, useLayoutEffect, useMemo, createElement, forwardRef } from 'react';
...
const TextDayPicker = forwardRef((_ref, ref) => {
  let {
    date = '',
    onChange,
