...
class FloatController extends fields.default {
  constructor(...args) {
    super(...args), _defineProperty(this, "getFilterGraphQL", ({type: type, value: value}) => ({
      ["is" === type ? "" + this.path : `${this.path}_${type}`]: parseFloat(value)
    ...
    _defineProperty(this, "formatFilter", ({label: label, value: value}) => `${this.getFilterLabel({
      ...
      return "number" == typeof value ? value : "string" == typeof value && value.length > 0 ? parseFloat(value) : null;
